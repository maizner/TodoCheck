    ...
    return (
        <div className="relative">
            <div className="flex flex-row gap-1 my-4 md:my-0">
                ...
                <div className="relative">
                    <button 
                        className={`${selectedPriority ? 'bg-td-primary-2 text-td-secondary-2' : 'bg-td-secondary-2 text-td-primary-2 font-bold'} flex flex-row items-center hover:bg-td-primary-2 border-2 hover:text-td-secondary-0 font-normal py-2 my-0 max-h-8 px-2 rounded-full text-[10px] leading-[10px]`}
